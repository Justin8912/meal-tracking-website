...
#
# Applies versioned SQL migrations (S-5), then starts the server. All config,
...
npm run migrate --workspace @meal-tracking/api

echo "Starting API server..."
exec npm start --workspace @meal-tracking/api
